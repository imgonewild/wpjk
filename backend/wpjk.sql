...
CREATE TABLE `wpjk` (
  ...
  `network_info` varchar(200) NOT NULL,
  `ip_address` varchar(255) DEFAULT NULL,
  `ip_type` varchar(255) DEFAULT NULL,
  `mac` varchar(255) DEFAULT NULL,
  `host_name` varchar(255) DEFAULT NULL,
  `pc_info` varchar(200) NOT NULL,
  ...
  `software_info` varchar(200) NOT NULL,
...
INSERT INTO `wpjk` (`plant`, `label`, `user`, `location`, `network_info`, `ip_address`, `ip_type`, `mac`, `host_name`, `pc_info`, `brand`, `model`, `service_id_or_serial_number`, `cpu`, `ram`, `storage`, `os_info`, `os_type`, `os_product_key`, `admin_account`, `password`, `software_info`, `office_version`, `office_product_key`, `old_office_version`, `old_office_product_key`, `antivirus`, `as400`, `others`) VALUES
...
('bopp', 'AM-CF-23101', 'Alan Yu', 'office', '', '172.17.32.11', 'dhcp', '', 'alan', '', 'dell', 'laptop', 'n/a', 'no', 'no', 'no', '', 'win11', 'no', 'no', 'no', '', 'no', 'no', 'no', 'no', 'no', '', NULL);
